...
<div class="mt-24 px-4 md:px-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Laporan Rekap Surat Izin Keluar</h1>
                <p class="text-gray-600 mt-1 text-sm md:text-base">Analisis dan monitoring data surat izin keluar siswa</p>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-3 border border-gray-200">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-800"><?= count($izinKeluar ?? []) ?> Records</p>
                    </div>
                </div>
            </div>
            <a href="<?= base_url('admin/laporan/masuk') ?>" class="bg-emerald-500 text-white px-4 py-2 rounded-lg hover:bg-emerald-600 transition-all">Lihat Izin Masuk</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
        ...
        <form method="get" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="flex flex-col md:flex-row items-end gap-2 lg:col-span-4">
                ...
                <a href="<?= base_url('admin/laporan/keluar') ?>" 
    ...
    <!-- Stats Overview (Hanya untuk Keluar) -->
